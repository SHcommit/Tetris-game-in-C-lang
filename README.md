...
✨<> code오른쪽 에 Insight 탭에서 Network메뉴로 가시면 특정 시점에 코드를 작성했습니다. 그곳에서 d16da7e 해시값일 때 배경없는 간단하지만 좌, 우 MaxLine일 때 블록 사라짐 등이 구현되어있습니다. 그 이후의 커밋은 배경 꾸밈 관련 메서드 작성 + 코드 리뷰 + 코드 보완입니다.
